...
def setup_product():
    ...
    import collective.blogstarentry
    zcml.load_config('configure.zcml', collective.blogstarentry)
    ...
    ztc.installPackage('collective.blogstarentry')
...
setup_product()
ptc.setupPloneSite(products=['collective.blogstarentry'])
